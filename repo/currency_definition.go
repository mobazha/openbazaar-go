...
var (
	...
	mainnetCryptoDefinitions = map[string]CurrencyDefinition{
		...
		"CFX": {Name: "Conflux", Code: CurrencyCode("CFX"), CurrencyType: Crypto, Divisibility: 18, BlockTime: 1 * time.Second},
	}
	testnetCryptoDefinitions = map[string]CurrencyDefinition{
		...
		"TCFX": {Name: "Testnet Conflux", Code: CurrencyCode("TCFX"), CurrencyType: Crypto, Divisibility: 18, BlockTime: 1 * time.Second},
	}
